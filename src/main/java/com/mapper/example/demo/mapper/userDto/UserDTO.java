package com.mapper.example.demo.mapper.userDto;
...
@JsonPropertyOrder({ "avatar", "player_id", "@id", "url", "username", "followers", "country", "last_online", "joined",
        "status", "is_streamer", "verified" })
...
public class UserDTO {
    ...
    public String toString() {
        return "userName:" + this.username + ", followers:" + this.followers;
    }
